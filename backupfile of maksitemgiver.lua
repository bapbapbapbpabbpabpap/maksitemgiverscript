...
genmenu("atools", "Infinite Gravity Gun", "ASCENSIONIST", "Immortality Lord", "NORMALIFYSCENSIONIST", "Megaphone", "Lost", "STARGLITCHER")
...
local function hotkeyGiver(v)
    ...
    elseif gui.toolsR1P2.Visible then
        ...
        elseif v == k6 then
			itemGiver("cookiecookie")
        elseif v == k7 then
			itemGiver("gingerbread")
        elseif v == k8 then
        elseif v == k9 then
            -- goto page 1
        end
